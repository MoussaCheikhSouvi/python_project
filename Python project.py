...
def CheckWinner():
    ...
    if winner ==1:
        messagebox.showinfo(title="مبروووك.",
            message="اللاعب 1 هو الفائز")
    elif winner ==2:
        messagebox.showinfo(title="مبروووك.",
            message="اللاعب 2 هو الفائز")
    elif mov ==9:
        messagebox.showinfo(title="التعادل",
            message="! إنه التعادل")
...
Button(text="اللعبة بدء ", font=('Papyrus', 22, 'bold'), bg='red', fg='white',
